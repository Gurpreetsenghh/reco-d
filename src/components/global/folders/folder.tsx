  ...
  const updateFolderName = (e: React.FocusEvent<HTMLInputElement>) => {
    if (inputRef.current) {
      if (inputRef.current.value) {
        // Fix 1: Removed redundant 'id' from the mutate payload
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'flex hover:bg-neutral-800 cursor-pointer transition duration-150 items-center gap-2 justify-between min-w-62.5 py-4 px-4 rounded-lg border'
      )}
    >
