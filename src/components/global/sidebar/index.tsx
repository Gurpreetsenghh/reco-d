...
import { WORKSPACES } from '@/redux/slices/workspaces/workspaces'
    ...
    <div className="bg-[#111111] flex-none relative p-4 h-full w-62.5 flex flex-col gap-4 items-center overflow-hidden">
      ...
      {currentWorkspace?.type === 'PUBLIC' &&
        workspace.subscription?.plan == 'PRO' && (
          <Modal
            trigger={
              <span className="text-sm cursor-pointer flex items-center justify-center bg-neutral-800/90  hover:bg-neutral-800/60 w-full rounded-sm p-1.25 gap-2">
                <PlusCircle
                  size={15}
