  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute left-0 w-full h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)] bg-slate-950" />
          <div className="absolute left-0 w-40 h-full bottom-0 z-20 mask-[linear-gradient(to_right,white,transparent)] bg-slate-950" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          <div className="absolute right-0 w-40 h-full bottom-0 z-20 mask-[linear-gradient(to_left,white,transparent)] bg-slate-950" />
          <div className="absolute right-0 w-full h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)] bg-slate-950" />
        </motion.div>
